defmodule Projectip.AnimalContextTest do
  use Projectip.DataCase
  ...
  describe "animals" do
    ...
    @valid_attrs %{cat_or_dog: "some cat_or_dog", dob: "some dob", name: "some name"}
    @update_attrs %{cat_or_dog: "some updated cat_or_dog", dob: "some updated dob", name: "some updated name"}
    ...
    test "update_animal/2 with valid data updates the animal" do
      ...
      assert animal.dob == "some updated dob"
